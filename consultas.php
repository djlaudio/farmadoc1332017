...
$ConsultaCitas="SELECT padecimiento.idCliente, padecimiento.observacion, concat(rtrim(padecimiento.fechaIngreso),' ',rtrim(padecimiento.padecimiento), '#',padecimento.medicamento) as nombreCompleto  from padecimiento";
