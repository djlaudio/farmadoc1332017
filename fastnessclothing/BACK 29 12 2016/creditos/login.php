<?php 
	...
	$sql = "SELECT CONCAT(p.name,' ', p.lastname) name, idTipoClientes, idRol, idUsuario, idArea from usuario u, person p WHERE u.idPersona=p.id and u.usuario LIKE '{$usuario}' AND u.clave LIKE '{$clave}' LIMIT 1";
