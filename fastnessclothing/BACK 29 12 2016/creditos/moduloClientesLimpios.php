...
<!-- /Actualizacion de datos -->
    ...
    <!-- Credito -->
    <div id="clientesaldia">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Envío de mensajes a buenos clientes</h2>
      <hr>
          </div>
...
<td class='text-center'><?php echo $row['deudaTotal'] ?></td>
 ...
 <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnEnviarMensaje" class="btn btn-primary">Enviar Mensaje a todos</button>
              </div>   
            </fieldset>  
...
<script type="text/javascript">
  $( "#btnEnviarMensaje" ).click(function() {
    ...
    $.ajax({
     type: 'post',
     url: 'functionEnviarMensajeALimpios.php',
     success: function (response) {
       alert(response);
     }
   });
