...
Editing:  
/home/newserver2016/public_html/marcasgenuinas.com/inventario/creditos/moduloClientesAtrasados.php
...
<fieldset>
  ...
  <!-- Actualizacion de datos indefinidos -->
    <div id="contact">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Clientes atrasados indefinidos</h2>
      <hr>
          </div>
          <div class="col-md-5 col-md-offset-3">
      <!-- contact form starts -->
...
$cuotas=15;
                ...
                $query = mysqli_query($link,"$ConsultaIndefinidosMorosos");
                while($row = mysqli_fetch_assoc($query)){?>
...
<td class='text-center'><?php echo $row['idCredito'] ?>
<td class='text-center'><?php echo $row['numFactura'] ?></td>
<td class='text-center' width="500" ><?php echo $row['name']; ?></td>
<td class='text-center'><?php echo $row['cantidadCredito'] ?></td>
<td class='text-center'><?php echo $row['montoPagado']; ?></td>
<td class='text-center'><?php echo $row['cuotaCredito']; ?></td>
<td class='text-center'><?php echo intval($row['cuotasAtrasadas']); ?></td>
